...
class AsyncImage(__gi_repository_Gtk.Image):
    """
    :Constructors:
    
    ::
    
        AsyncImage(**properties)
        new(load_on_realize:bool, auto_size_request:bool) -> Granite.AsyncImage
        from_gicon_async(icon:Gio.Icon, size:int, load_on_realize:bool, auto_size_request:bool) -> Granite.AsyncImage
        from_icon_name_async(icon_name:str, icon_size:Gtk.IconSize, load_on_realize:bool, auto_size_request:bool) -> Granite.AsyncImage
    """
    ...
    def from_gicon_async(self, icon, size, load_on_realize, auto_size_request): # real signature unknown; restored from __doc__
        """ from_gicon_async(icon:Gio.Icon, size:int, load_on_realize:bool, auto_size_request:bool) -> Granite.AsyncImage """
        pass

    def from_icon_name_async(self, icon_name, icon_size, load_on_realize, auto_size_request): # real signature unknown; restored from __doc__
        """ from_icon_name_async(icon_name:str, icon_size:Gtk.IconSize, load_on_realize:bool, auto_size_request:bool) -> Granite.AsyncImage """
        pass
    ...
    def get_gicon_async(self): # real signature unknown; restored from __doc__
        """ get_gicon_async(self) -> Gio.Icon """
        pass
    ...
    def get_size_async(self): # real signature unknown; restored from __doc__
        """ get_size_async(self) -> int """
        return 0
    ...
    def new(self, load_on_realize, auto_size_request): # real signature unknown; restored from __doc__
        """ new(load_on_realize:bool, auto_size_request:bool) -> Granite.AsyncImage """
        pass
    ...
    def set_from_file_async(self, file, width, height, preserve_aspect_ratio, cancellable=None, _callback_=None, _callback__target=None): # real signature unknown; restored from __doc__
        """ set_from_file_async(self, file:Gio.File, width:int, height:int, preserve_aspect_ratio:bool, cancellable:Gio.Cancellable=None, _callback_:Gio.AsyncReadyCallback=None, _callback__target=None) """
        pass

    def set_from_file_finish(self, _res_): # real signature unknown; restored from __doc__
        """ set_from_file_finish(self, _res_:Gio.AsyncResult) """
        pass
    ...
    def set_from_gicon_async(self, icon, size, cancellable=None, _callback_=None, _callback__target=None): # real signature unknown; restored from __doc__
        """ set_from_gicon_async(self, icon:Gio.Icon, size:int, cancellable:Gio.Cancellable=None, _callback_:Gio.AsyncReadyCallback=None, _callback__target=None) """
        pass

    def set_from_gicon_finish(self, _res_): # real signature unknown; restored from __doc__
        """ set_from_gicon_finish(self, _res_:Gio.AsyncResult) """
        pass
    ...
    def set_from_icon_name_async(self, icon_name, icon_size, cancellable=None, _callback_=None, _callback__target=None): # real signature unknown; restored from __doc__
        """ set_from_icon_name_async(self, icon_name:str, icon_size:Gtk.IconSize, cancellable:Gio.Cancellable=None, _callback_:Gio.AsyncReadyCallback=None, _callback__target=None) """
        pass

    def set_from_icon_name_finish(self, _res_): # real signature unknown; restored from __doc__
        """ set_from_icon_name_finish(self, _res_:Gio.AsyncResult) """
        pass
