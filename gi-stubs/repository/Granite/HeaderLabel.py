...
class HeaderLabel(__gi_overrides_Gtk.Label):
    """
    :Constructors:
    ...
    ::
        ...
        new(label:str) -> Granite.HeaderLabel
    """
    ...
    def new(self, label): # real signature unknown; restored from __doc__
        """ new(label:str) -> Granite.HeaderLabel """
        pass
