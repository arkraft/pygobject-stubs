...
class MessageDialog(__gi_overrides_Gtk.Dialog):
    """
    :Constructors:
    ...
    ::
        ...
        new(primary_text:str, secondary_text:str, image_icon:Gio.Icon, buttons:Gtk.ButtonsType) -> Granite.MessageDialog
        with_image_from_icon_name(primary_text:str, secondary_text:str, image_icon_name:str, buttons:Gtk.ButtonsType) -> Granite.MessageDialog
    """
    ...
    def get_badge_icon(self): # real signature unknown; restored from __doc__
        """ get_badge_icon(self) -> Gio.Icon """
        pass
    ...
    def get_custom_bin(self): # real signature unknown; restored from __doc__
        """ get_custom_bin(self) -> Gtk.Bin """
        pass
    ...
    def get_image_icon(self): # real signature unknown; restored from __doc__
        """ get_image_icon(self) -> Gio.Icon """
        pass
    ...
    def get_primary_label(self): # real signature unknown; restored from __doc__
        """ get_primary_label(self) -> Gtk.Label """
        pass

    def get_primary_text(self): # real signature unknown; restored from __doc__
        """ get_primary_text(self) -> str """
        return ""
    ...
    def get_secondary_label(self): # real signature unknown; restored from __doc__
        """ get_secondary_label(self) -> Gtk.Label """
        pass

    def get_secondary_text(self): # real signature unknown; restored from __doc__
        """ get_secondary_text(self) -> str """
        return ""
    ...
    def new(self, primary_text, secondary_text, image_icon, buttons): # real signature unknown; restored from __doc__
        """ new(primary_text:str, secondary_text:str, image_icon:Gio.Icon, buttons:Gtk.ButtonsType) -> Granite.MessageDialog """
        pass
    ...
    def set_badge_icon(self, value): # real signature unknown; restored from __doc__
        """ set_badge_icon(self, value:Gio.Icon) """
        pass
    ...
    def set_image_icon(self, value): # real signature unknown; restored from __doc__
        """ set_image_icon(self, value:Gio.Icon) """
        pass
    ...
    def set_primary_text(self, value): # real signature unknown; restored from __doc__
        """ set_primary_text(self, value:str) """
        pass
    ...
    def set_secondary_text(self, value): # real signature unknown; restored from __doc__
        """ set_secondary_text(self, value:str) """
        pass
    ...
    def show_error_details(self, error_message): # real signature unknown; restored from __doc__
        """ show_error_details(self, error_message:str) """
        pass
    ...
    def with_image_from_icon_name(self, primary_text, secondary_text, image_icon_name, buttons): # real signature unknown; restored from __doc__
        """ with_image_from_icon_name(primary_text:str, secondary_text:str, image_icon_name:str, buttons:Gtk.ButtonsType) -> Granite.MessageDialog """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f832ef743c8>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
