...
class SeekBar(__gi_repository_Gtk.Grid):
    """
    :Constructors:
    ...
    ::
        ...
        SeekBar(**properties)
        new(playback_duration:float) -> Granite.SeekBar
    """
    ...
    def get_duration_label(self): # real signature unknown; restored from __doc__
        """ get_duration_label(self) -> Gtk.Label """
        pass
    ...
    def get_is_grabbing(self): # real signature unknown; restored from __doc__
        """ get_is_grabbing(self) -> bool """
        return False

    def get_is_hovering(self): # real signature unknown; restored from __doc__
        """ get_is_hovering(self) -> bool """
        return False
    ...
    def get_playback_duration(self): # real signature unknown; restored from __doc__
        """ get_playback_duration(self) -> float """
        return 0.0

    def get_playback_progress(self): # real signature unknown; restored from __doc__
        """ get_playback_progress(self) -> float """
        return 0.0
    ...
    def get_progression_label(self): # real signature unknown; restored from __doc__
        """ get_progression_label(self) -> Gtk.Label """
        pass
    ...
    def new(self, playback_duration): # real signature unknown; restored from __doc__
        """ new(playback_duration:float) -> Granite.SeekBar """
        pass
    ...
    def set_duration_label(self, value): # real signature unknown; restored from __doc__
        """ set_duration_label(self, value:Gtk.Label) """
        pass
    ...
    def set_playback_duration(self, value): # real signature unknown; restored from __doc__
        """ set_playback_duration(self, value:float) """
        pass

    def set_playback_progress(self, value): # real signature unknown; restored from __doc__
        """ set_playback_progress(self, value:float) """
        pass

    def set_progression_label(self, value): # real signature unknown; restored from __doc__
        """ set_progression_label(self, value:Gtk.Label) """
        pass
    ...
    def set_scale(self, value): # real signature unknown; restored from __doc__
        """ set_scale(self, value:Gtk.Scale) """
        pass
