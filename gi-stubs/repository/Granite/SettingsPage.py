...
class SettingsPage(__gi_overrides_Gtk.ScrolledWindow):
    """
    :Constructors:
    ...
    def set_icon_name(self, value=None): # real signature unknown; restored from __doc__
        """ set_icon_name(self, value:str=None) """
        pass
