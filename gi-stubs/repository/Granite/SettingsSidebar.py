...
class SettingsSidebar(__gi_overrides_Gtk.ScrolledWindow):
    """
    :Constructors:
    ...
    ::
        ...
        new(stack:Gtk.Stack) -> Granite.SettingsSidebar
    """
    ...
    def new(self, stack): # real signature unknown; restored from __doc__
        """ new(stack:Gtk.Stack) -> Granite.SettingsSidebar """
        pass
    ...
    def set_visible_child_name(self, value=None): # real signature unknown; restored from __doc__
        """ set_visible_child_name(self, value:str=None) """
        pass
