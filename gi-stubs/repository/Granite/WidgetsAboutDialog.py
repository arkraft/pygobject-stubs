...
class WidgetsAboutDialog(GtkPatchAboutDialog):
    ...
    ::
        ...
        WidgetsAboutDialog(**properties)
        new() -> Granite.WidgetsAboutDialog
    """
    ...
    def get_bug(self): # real signature unknown; restored from __doc__
        """ get_bug(self) -> str """
        return ""
    ...
    def set_bug(self, value): # real signature unknown; restored from __doc__
        """ set_bug(self, value:str) """
        pass
    ...
    def set_help(self, value): # real signature unknown; restored from __doc__
        """ set_help(self, value:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f832ee0a240>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
