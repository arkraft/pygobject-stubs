...
class WidgetsAlertView(__gi_repository_Gtk.Grid):
    """
    :Constructors:
    
    ::
    
        WidgetsAlertView(**properties)
        new(title:str, description:str, icon_name:str) -> Granite.WidgetsAlertView
    """
    ...
    def hide_action(self): # real signature unknown; restored from __doc__
        """ hide_action(self) """
        pass
    ...
    def new(self, title, description, icon_name): # real signature unknown; restored from __doc__
        """ new(title:str, description:str, icon_name:str) -> Granite.WidgetsAlertView """
        pass
    ...
    def show_action(self, label=None): # real signature unknown; restored from __doc__
        """ show_action(self, label:str=None) """
        pass
