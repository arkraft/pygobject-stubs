...
class WidgetsAppMenu(__gi_repository_Gtk.MenuButton):
    """
    :Constructors:
    
    ::
    
        WidgetsAppMenu(**properties)
        new(menu:Gtk.Menu) -> Granite.WidgetsAppMenu
        with_app(application:Granite.Application=None, menu:Gtk.Menu) -> Granite.WidgetsAppMenu
    """
    ...
    def add_items(self, menu): # real signature unknown; restored from __doc__
        """ add_items(self, menu:Gtk.Menu) """
        pass
    ...
    def new(self, menu): # real signature unknown; restored from __doc__
        """ new(menu:Gtk.Menu) -> Granite.WidgetsAppMenu """
        pass
    ...
    def with_app(self, application=None, menu): # real signature unknown; restored from __doc__
        """ with_app(application:Granite.Application=None, menu:Gtk.Menu) -> Granite.WidgetsAppMenu """
        pass
    ...
    about_item = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
