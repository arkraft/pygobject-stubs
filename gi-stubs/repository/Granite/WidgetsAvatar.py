...
class WidgetsAvatar(__gi_repository_Gtk.EventBox):
    """
    :Constructors:
    
    ::
    
        WidgetsAvatar(**properties)
        new() -> Granite.WidgetsAvatar
        from_pixbuf(pixbuf:GdkPixbuf.Pixbuf) -> Granite.WidgetsAvatar
        from_file(filepath:str, pixel_size:int) -> Granite.WidgetsAvatar
        with_default_icon(pixel_size:int) -> Granite.WidgetsAvatar
    """
    ...
    def from_file(self, filepath, pixel_size): # real signature unknown; restored from __doc__
        """ from_file(filepath:str, pixel_size:int) -> Granite.WidgetsAvatar """
        pass

    def from_pixbuf(self, pixbuf): # real signature unknown; restored from __doc__
        """ from_pixbuf(pixbuf:GdkPixbuf.Pixbuf) -> Granite.WidgetsAvatar """
        pass
    ...
    def set_pixbuf(self, value=None): # real signature unknown; restored from __doc__
        """ set_pixbuf(self, value:GdkPixbuf.Pixbuf=None) """
        pass
    ...
    def show_default(self, pixel_size): # real signature unknown; restored from __doc__
        """ show_default(self, pixel_size:int) """
        pass
    ...
    def with_default_icon(self, pixel_size): # real signature unknown; restored from __doc__
        """ with_default_icon(pixel_size:int) -> Granite.WidgetsAvatar """
        pass
