...
class WidgetsCellRendererBadge(__gi_repository_Gtk.CellRenderer):
    """
    :Constructors:
    
    ::
    
        WidgetsCellRendererBadge(**properties)
        new() -> Granite.WidgetsCellRendererBadge
    """
    ...
    def set_text(self, value): # real signature unknown; restored from __doc__
        """ set_text(self, value:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f832eec5b38>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(WidgetsCellRendererBadge), '__module__': 'gi.repository.Granite', '__gtype__': <GType GraniteWidgetsCellRendererBadge (31621728)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_text': gi.FunctionInfo(get_text), 'set_text': gi.FunctionInfo(set_text), 'parent_instance': <property object at 0x7f832ef77bd8>, 'priv': <property object at 0x7f832ef77c28>})"
    __gdoc__ = 'Object GraniteWidgetsCellRendererBadge\n\nProperties from GraniteWidgetsCellRendererBadge:\n  text -> gchararray: text\n    text\n\nSignals from GtkCellRenderer:\n  editing-canceled ()\n  editing-started (GtkCellEditable, gchararray)\n\nProperties from GtkCellRenderer:\n  mode -> GtkCellRendererMode: mode\n    Editable mode of the CellRenderer\n  visible -> gboolean: visible\n    Display the cell\n  sensitive -> gboolean: Sensitive\n    Display the cell sensitive\n  xalign -> gfloat: xalign\n    The x-align\n  yalign -> gfloat: yalign\n    The y-align\n  xpad -> guint: xpad\n    The xpad\n  ypad -> guint: ypad\n    The ypad\n  width -> gint: width\n    The fixed width\n  height -> gint: height\n    The fixed height\n  is-expander -> gboolean: Is Expander\n    Row has children\n  is-expanded -> gboolean: Is Expanded\n    Row is an expander row, and is expanded\n  cell-background -> gchararray: Cell background color name\n    Cell background color as a string\n  cell-background-gdk -> GdkColor: Cell background color\n    Cell background color as a GdkColor\n  cell-background-rgba -> GdkRGBA: Cell background RGBA color\n    Cell background color as a GdkRGBA\n  cell-background-set -> gboolean: Cell background set\n    Whether the cell background color is set\n  editing -> gboolean: Editing\n    Whether the cell renderer is currently in editing mode\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GraniteWidgetsCellRendererBadge (31621728)>'
    __info__ = ObjectInfo(WidgetsCellRendererBadge)
