...
class WidgetsCellRendererExpander(__gi_repository_Gtk.CellRenderer):
    """
    :Constructors:
    
    ::
    
        WidgetsCellRendererExpander(**properties)
        new() -> Granite.WidgetsCellRendererExpander
    """
    ...
    def do_get_arrow_size(self, *args, **kwargs): # real signature unknown
        """ get_arrow_size(self, widget:Gtk.Widget) -> int """
        pass
    ...
    def get_arrow_size(self, widget): # real signature unknown; restored from __doc__
        """ get_arrow_size(self, widget:Gtk.Widget) -> int """
        return 0
    ...
    def get_is_category_expander(self): # real signature unknown; restored from __doc__
        """ get_is_category_expander(self) -> bool """
        return False
    ...
    def set_is_category_expander(self, value): # real signature unknown; restored from __doc__
        """ set_is_category_expander(self, value:bool) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x7f832ef9afd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(WidgetsCellRendererExpander), '__module__': 'gi.repository.Granite', '__gtype__': <GType GraniteWidgetsCellRendererExpander (31621984)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'get_arrow_size': gi.FunctionInfo(get_arrow_size), 'get_is_category_expander': gi.FunctionInfo(get_is_category_expander), 'set_is_category_expander': gi.FunctionInfo(set_is_category_expander), 'do_get_arrow_size': gi.VFuncInfo(get_arrow_size), 'parent_instance': <property object at 0x7f832ef77ef8>, 'priv': <property object at 0x7f832ef77f48>})"
    __gdoc__ = 'Object GraniteWidgetsCellRendererExpander\n\nProperties from GraniteWidgetsCellRendererExpander:\n  is-category-expander -> gboolean: is-category-expander\n    is-category-expander\n\nSignals from GtkCellRenderer:\n  editing-canceled ()\n  editing-started (GtkCellEditable, gchararray)\n\nProperties from GtkCellRenderer:\n  mode -> GtkCellRendererMode: mode\n    Editable mode of the CellRenderer\n  visible -> gboolean: visible\n    Display the cell\n  sensitive -> gboolean: Sensitive\n    Display the cell sensitive\n  xalign -> gfloat: xalign\n    The x-align\n  yalign -> gfloat: yalign\n    The y-align\n  xpad -> guint: xpad\n    The xpad\n  ypad -> guint: ypad\n    The ypad\n  width -> gint: width\n    The fixed width\n  height -> gint: height\n    The fixed height\n  is-expander -> gboolean: Is Expander\n    Row has children\n  is-expanded -> gboolean: Is Expanded\n    Row is an expander row, and is expanded\n  cell-background -> gchararray: Cell background color name\n    Cell background color as a string\n  cell-background-gdk -> GdkColor: Cell background color\n    Cell background color as a GdkColor\n  cell-background-rgba -> GdkRGBA: Cell background RGBA color\n    Cell background color as a GdkRGBA\n  cell-background-set -> gboolean: Cell background set\n    Whether the cell background color is set\n  editing -> gboolean: Editing\n    Whether the cell renderer is currently in editing mode\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GraniteWidgetsCellRendererExpander (31621984)>'
    __info__ = ObjectInfo(WidgetsCellRendererExpander)
