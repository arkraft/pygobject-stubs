...
class WidgetsCollapsiblePaned(__gi_overrides_Gtk.Paned):
    """
    :Constructors:
    
    ::
    
        WidgetsCollapsiblePaned(**properties)
        new(orientation:Gtk.Orientation) -> Granite.WidgetsCollapsiblePaned
    """
    ...
    def get_collapse_mode(self): # real signature unknown; restored from __doc__
        """ get_collapse_mode(self) -> Granite.CollapseMode """
        pass
    ...
    def set_collapse_mode(self, value): # real signature unknown; restored from __doc__
        """ set_collapse_mode(self, value:Granite.CollapseMode) """
        pass
