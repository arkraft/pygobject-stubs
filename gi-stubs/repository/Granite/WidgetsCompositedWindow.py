...
class WidgetsCompositedWindow(__gi_overrides_Gtk.Window):
    """
    :Constructors:
    
    ::
    
        WidgetsCompositedWindow(**properties)
        new() -> Granite.WidgetsCompositedWindow
    """
