...
class WidgetsDatePicker(__gi_repository_Gtk.Entry):
    """
    :Constructors:
    
    ::
    
        WidgetsDatePicker(**properties)
        with_format(format:str) -> Granite.WidgetsDatePicker
        new() -> Granite.WidgetsDatePicker
    """
    ...
    def do_position_dropdown(self, *args, **kwargs): # real signature unknown
        """ position_dropdown(self) -> rect:Gdk.Rectangle """
        pass
    ...
    def set_date(self, value): # real signature unknown; restored from __doc__
        """ set_date(self, value:GLib.DateTime) """
        pass
    ...
    def with_format(self, format): # real signature unknown; restored from __doc__
        """ with_format(format:str) -> Granite.WidgetsDatePicker """
        pass
