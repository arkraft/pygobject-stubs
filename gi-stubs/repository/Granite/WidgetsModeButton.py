...
class WidgetsModeButton(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    
    ::
    
        WidgetsModeButton(**properties)
        new() -> Granite.WidgetsModeButton
    """
    ...
    def append(self, w): # real signature unknown; restored from __doc__
        """ append(self, w:Gtk.Widget) -> int """
        return 0

    def append_icon(self, icon_name, size): # real signature unknown; restored from __doc__
        """ append_icon(self, icon_name:str, size:Gtk.IconSize) -> int """
        return 0

    def append_pixbuf(self, pixbuf): # real signature unknown; restored from __doc__
        """ append_pixbuf(self, pixbuf:GdkPixbuf.Pixbuf) -> int """
        return 0

    def append_text(self, text): # real signature unknown; restored from __doc__
        """ append_text(self, text:str) -> int """
        return 0
    ...
    def clear_children(self): # real signature unknown; restored from __doc__
        """ clear_children(self) """
        pass
    ...
    def set_active(self, new_active_index): # real signature unknown; restored from __doc__
        """ set_active(self, new_active_index:int) """
        pass
    ...
    def set_selected(self, value): # real signature unknown; restored from __doc__
        """ set_selected(self, value:int) """
        pass
