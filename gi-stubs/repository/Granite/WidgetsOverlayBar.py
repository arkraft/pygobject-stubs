...
class WidgetsOverlayBar(__gi_repository_Gtk.EventBox):
    """
    :Constructors:
    
    ::
    
        WidgetsOverlayBar(**properties)
        new(overlay:Gtk.Overlay=None) -> Granite.WidgetsOverlayBar
    """
    ...
    def get_overlay(self): # real signature unknown; restored from __doc__
        """ get_overlay(self) -> Gtk.Overlay """
        pass
    ...
    def new(self, overlay=None): # real signature unknown; restored from __doc__
        """ new(overlay:Gtk.Overlay=None) -> Granite.WidgetsOverlayBar """
        pass
