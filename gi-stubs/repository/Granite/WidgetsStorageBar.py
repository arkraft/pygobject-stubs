...
class WidgetsStorageBar(__gi_overrides_Gtk.Box):
    """
    :Constructors:
    
    ::
    
        WidgetsStorageBar(**properties)
        new(storage:int) -> Granite.WidgetsStorageBar
        with_total_usage(storage:int, total_usage:int) -> Granite.WidgetsStorageBar
    """
    ...
    def get_inner_margin_sides(self): # real signature unknown; restored from __doc__
        """ get_inner_margin_sides(self) -> int """
        return 0
    ...
    def get_total_usage(self): # real signature unknown; restored from __doc__
        """ get_total_usage(self) -> int """
        return 0
    ...
    def new(self, storage): # real signature unknown; restored from __doc__
        """ new(storage:int) -> Granite.WidgetsStorageBar """
        pass
    ...
    def set_inner_margin_sides(self, value): # real signature unknown; restored from __doc__
        """ set_inner_margin_sides(self, value:int) """
        pass
    ...
    def set_storage(self, value): # real signature unknown; restored from __doc__
        """ set_storage(self, value:int) """
        pass
    ...
    def set_total_usage(self, value): # real signature unknown; restored from __doc__
        """ set_total_usage(self, value:int) """
        pass
    ...
    def update_block_size(self, description, size): # real signature unknown; restored from __doc__
        """ update_block_size(self, description:Granite.WidgetsStorageBarItemDescription, size:int) """
        pass
    ...
    def with_total_usage(self, storage, total_usage): # real signature unknown; restored from __doc__
        """ with_total_usage(storage:int, total_usage:int) -> Granite.WidgetsStorageBar """
        pass
