...
class WidgetsToast(__gi_repository_Gtk.Revealer):
    """
    :Constructors:
    
    ::
    
        WidgetsToast(**properties)
        new(title:str) -> Granite.WidgetsToast
    """
    ...
    def send_notification(self): # real signature unknown; restored from __doc__
    ...
    def set_default_action(self, label=None): # real signature unknown; restored from __doc__
        """ set_default_action(self, label:str=None) """
        pass
