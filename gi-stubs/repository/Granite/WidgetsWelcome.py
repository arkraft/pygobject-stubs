...
class WidgetsWelcome(__gi_repository_Gtk.EventBox):
    """
    :Constructors:
    
    ::
    
        WidgetsWelcome(**properties)
        new(title_text:str, subtitle_text:str) -> Granite.WidgetsWelcome
    """
    ...
    def append(self, icon_name, option_text, description_text): # real signature unknown; restored from __doc__
        """ append(self, icon_name:str, option_text:str, description_text:str) -> int """
        return 0

    def append_with_image(self, image=None, option_text, description_text): # real signature unknown; restored from __doc__
        """ append_with_image(self, image:Gtk.Image=None, option_text:str, description_text:str) -> int """
        return 0

    def append_with_pixbuf(self, pixbuf=None, option_text, description_text): # real signature unknown; restored from __doc__
        """ append_with_pixbuf(self, pixbuf:GdkPixbuf.Pixbuf=None, option_text:str, description_text:str) -> int """
        return 0
    ...
    def get_button_from_index(self, index): # real signature unknown; restored from __doc__
        """ get_button_from_index(self, index:int) -> Granite.WidgetsWelcomeButton """
        pass
    ...
    def new(self, title_text, subtitle_text): # real signature unknown; restored from __doc__
        """ new(title_text:str, subtitle_text:str) -> Granite.WidgetsWelcome """
        pass
    ...
    def remove_item(self, index): # real signature unknown; restored from __doc__
    ...
    def set_item_sensitivity(self, index, val): # real signature unknown; restored from __doc__
        """ set_item_sensitivity(self, index:int, val:bool) """
        pass

    def set_item_visible(self, index, val): # real signature unknown; restored from __doc__
        """ set_item_visible(self, index:int, val:bool) """
        pass
    ...
    def set_subtitle(self, value): # real signature unknown; restored from __doc__
        """ set_subtitle(self, value:str) """
        pass
