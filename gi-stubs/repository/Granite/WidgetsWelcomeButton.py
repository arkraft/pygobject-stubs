...
class WidgetsWelcomeButton(__gi_overrides_Gtk.Button):
    """
    :Constructors:
    
    ::
    
        WidgetsWelcomeButton(**properties)
        new(image:Gtk.Image=None, option_text:str, description_text:str) -> Granite.WidgetsWelcomeButton
    """
    ...
    def new(self, image=None, option_text, description_text): # real signature unknown; restored from __doc__
        """ new(image:Gtk.Image=None, option_text:str, description_text:str) -> Granite.WidgetsWelcomeButton """
        pass
    ...
    def set_icon(self, value=None): # real signature unknown; restored from __doc__
        """ set_icon(self, value:Gtk.Image=None) """
        pass
