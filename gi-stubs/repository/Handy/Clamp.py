...
class Clamp(__gi_repository_Gtk.Bin, __gi_repository_Gtk.Orientable):
    """
    :Constructors:
    ...
    def get_maximum_size(self): # real signature unknown; restored from __doc__
        """ get_maximum_size(self) -> int """
        return 0
    ...
    def get_tightening_threshold(self): # real signature unknown; restored from __doc__
        """ get_tightening_threshold(self) -> int """
        return 0
    ...
    def set_maximum_size(self, maximum_size): # real signature unknown; restored from __doc__
        """ set_maximum_size(self, maximum_size:int) """
        pass
    ...
    def set_tightening_threshold(self, tightening_threshold): # real signature unknown; restored from __doc__
        """ set_tightening_threshold(self, tightening_threshold:int) """
        pass
