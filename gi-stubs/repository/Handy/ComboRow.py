...
class ComboRow(ActionRow):
    ...
    def bind_model(self, model=None, create_list_widget_func=None, create_current_widget_func=None, user_data=None): # real signature unknown; restored from __doc__
        """ bind_model(self, model:Gio.ListModel=None, create_list_widget_func:Gtk.ListBoxCreateWidgetFunc=None, create_current_widget_func:Gtk.ListBoxCreateWidgetFunc=None, user_data=None) """
        pass

    def bind_name_model(self, model=None, get_name_func=None, user_data=None): # real signature unknown; restored from __doc__
        """ bind_name_model(self, model:Gio.ListModel=None, get_name_func:Handy.ComboRowGetNameFunc=None, user_data=None) """
        pass
    ...
    def get_model(self): # real signature unknown; restored from __doc__
        """ get_model(self) -> Gio.ListModel or None """
        pass
    ...
    def get_selected_index(self): # real signature unknown; restored from __doc__
    ...
    def get_use_subtitle(self): # real signature unknown; restored from __doc__
        """ get_use_subtitle(self) -> bool """
        return False
    ...
    def set_for_enum(self, enum_type, get_name_func=None, user_data=None): # real signature unknown; restored from __doc__
        """ set_for_enum(self, enum_type:GType, get_name_func:Handy.ComboRowGetEnumValueNameFunc=None, user_data=None) """
        pass

    def set_get_name_func(self, get_name_func=None, user_data=None): # real signature unknown; restored from __doc__
        """ set_get_name_func(self, get_name_func:Handy.ComboRowGetNameFunc=None, user_data=None) """
        pass
    ...
    def set_selected_index(self, selected_index): # real signature unknown; restored from __doc__
        """ set_selected_index(self, selected_index:int) """
        pass
    ...
    def set_use_subtitle(self, use_subtitle): # real signature unknown; restored from __doc__
        """ set_use_subtitle(self, use_subtitle:bool) """
        pass
