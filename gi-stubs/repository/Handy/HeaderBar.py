...
class HeaderBar(__gi_overrides_Gtk.Container):
    ...
    def get_centering_policy(self): # real signature unknown; restored from __doc__
        """ get_centering_policy(self) -> Handy.CenteringPolicy """
        pass
    ...
    def set_centering_policy(self, centering_policy): # real signature unknown; restored from __doc__
        """ set_centering_policy(self, centering_policy:Handy.CenteringPolicy) """
        pass
