...
class Keypad(__gi_repository_Gtk.Bin):
    ...
    ::
        ...
        Keypad(**properties)
        new(only_digits:bool, show_symbols:bool) -> Gtk.Widget
    """
    ...
    def new(self, only_digits, show_symbols): # real signature unknown; restored from __doc__
        """ new(only_digits:bool, show_symbols:bool) -> Gtk.Widget """
        pass
    ...
    def set_entry(self, entry): # real signature unknown; restored from __doc__
        """ set_entry(self, entry:Gtk.Entry) """
        pass
    ...
    def set_left_action(self, widget): # real signature unknown; restored from __doc__
        """ set_left_action(self, widget:Gtk.Widget) """
        pass
    ...
    def show_symbols(self, visible): # real signature unknown; restored from __doc__
        """ show_symbols(self, visible:bool) """
        pass
