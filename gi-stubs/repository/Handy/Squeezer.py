...
class Squeezer(__gi_overrides_Gtk.Container, __gi_repository_Gtk.Orientable):
    """
    :Constructors:
    ...
    def get_child_enabled(self, child): # real signature unknown; restored from __doc__
        """ get_child_enabled(self, child:Gtk.Widget) -> bool """
        return False
    ...
    def get_transition_type(self): # real signature unknown; restored from __doc__
        """ get_transition_type(self) -> Handy.SqueezerTransitionType """
        pass
    ...
    def set_child_enabled(self, child, enabled): # real signature unknown; restored from __doc__
        """ set_child_enabled(self, child:Gtk.Widget, enabled:bool) """
        pass
    ...
    def set_transition_type(self, transition): # real signature unknown; restored from __doc__
        """ set_transition_type(self, transition:Handy.SqueezerTransitionType) """
        pass
