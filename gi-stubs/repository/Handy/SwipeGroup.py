...
class SwipeGroup(__gi_overrides_GObject.Object, __gi_repository_Gtk.Buildable):
    """
    :Constructors:
    ...
    def add_swipeable(self, swipeable): # real signature unknown; restored from __doc__
        """ add_swipeable(self, swipeable:Handy.Swipeable) """
        pass
    ...
    def get_swipeables(self): # real signature unknown; restored from __doc__
        """ get_swipeables(self) -> list """
        return []
    ...
    def remove_swipeable(self, swipeable): # real signature unknown; restored from __doc__
        """ remove_swipeable(self, swipeable:Handy.Swipeable) """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SwipeGroup), '__module__': 'gi.repository.Handy', '__gtype__': <GType HdySwipeGroup (33381088)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new), 'add_swipeable': gi.FunctionInfo(add_swipeable), 'get_swipeables': gi.FunctionInfo(get_swipeables), 'remove_swipeable': gi.FunctionInfo(remove_swipeable)})"
    __gdoc__ = 'Object HdySwipeGroup\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType HdySwipeGroup (33381088)>'
    __info__ = ObjectInfo(SwipeGroup)
