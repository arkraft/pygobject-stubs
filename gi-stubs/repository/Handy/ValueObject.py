...
class ValueObject(__gi_overrides_GObject.Object):
    """
    :Constructors:
    ...
    def copy_value(self, dest): # real signature unknown; restored from __doc__
        """ copy_value(self, dest:GObject.Value) """
        pass
    ...
    def new(self, value): # real signature unknown; restored from __doc__
        """ new(value:GObject.Value) -> Handy.ValueObject """
        pass
