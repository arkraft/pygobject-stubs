...
class ViewSwitcher(__gi_repository_Gtk.Bin):
    """
    :Constructors:
    ...
    def get_narrow_ellipsize(self): # real signature unknown; restored from __doc__
        """ get_narrow_ellipsize(self) -> Pango.EllipsizeMode """
        pass
    ...
    def set_narrow_ellipsize(self, mode): # real signature unknown; restored from __doc__
        """ set_narrow_ellipsize(self, mode:Pango.EllipsizeMode) """
        pass
