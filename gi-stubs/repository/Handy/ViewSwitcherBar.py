...
class ViewSwitcherBar(__gi_repository_Gtk.Bin):
    """
    :Constructors:
    ...
    def get_reveal(self): # real signature unknown; restored from __doc__
        """ get_reveal(self) -> bool """
        return False
    ...
    def set_reveal(self, reveal): # real signature unknown; restored from __doc__
        """ set_reveal(self, reveal:bool) """
        pass
